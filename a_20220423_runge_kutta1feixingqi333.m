function [t,x]=a_20220423_runge_kutta1feixingqi333(x0,h,a,b)%参数表顺序依次是微分方程组的函数名称，初始值向量，步长，时间起点，时间终点（参数形式参考了ode45函数）
n=floor((b-a)/h);%求步数
t(1)=a;%时间起点
...
JT1(1)=0;JT2(1)=0;JT3(1)=0;JT4(1)=0;JT5(1)=0;timet2(1)=0;UUU1(1)=0;
timet2(i2+1)=t;
JT1(i2+1)=costr1;JT2(i2+1)=costr2;UUU1(i2+1)=unew1'*unew1;
